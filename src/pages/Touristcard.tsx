...
export default function Touristcard({ entry }: TouristcardProps) {
  //const {entry} = props
  ...
  return (
    <div className="z-0 dark:bg-gray-900 font-sans">
        ...
        <article key={index} className="card dark:bg-gray-900">
          ...
          <div className="journal-info">
            <div className="location">
              ...
              <a href={entry.googleMapsLink} className="link hover:underline">
                View on google maps
              </a>
            </div>
            <div className="desc">
