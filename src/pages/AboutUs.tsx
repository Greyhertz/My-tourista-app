...
//               className="space-y-6"
//             >
//               <Badge className="bg-gradient-to-r from-primary to-accent text-primary-foreground bg-tr px-4 py-2 text-sm hover:from-primary/90 hover:to-accent/90">
...
//   );
// }
// /* (removed erroneous local useRef definition; using React's useRef instead) */
...
import { Card, CardContent } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Leaf, ShieldCheck, Snowflake, ArrowRight } from 'lucide-react';

/**
 * ABOUT PAGE — PIXEL‑PERFECT REPLICATION
 * Section 1: Header / Hero (exact layout match)
 * Section 2: Trust / Details (exact continuation)
 */
...
function AboutHeaderSection() {
  return (
    <section className="relative bg-background py-24">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.05),transparent_70%)]" />

      <div className="relative mx-auto max-w-7xl px-6">
        {/* Section title */}
        <h2 className="mb-10 text-3xl font-medium text-muted-foreground">
          About Wanderly
        </h2>
        ...
        <div className="relative grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          {/* FLOATING CONTENT CARD (RIGHT) */}
          <Card className="absolute right-0 top-24 w-full max-w-md rounded-2xl border-border bg-card/90 backdrop-blur lg:static">
            <CardContent className="p-6">
              <h3 className="mb-4 text-xl font-semibold text-primary">
                Our Commitment to Travel Excellence
              </h3>
              <p className="text-sm leading-relaxed text-muted-foreground">
                At Wanderly, we believe travel should be authentic and
                enriching. Every destination we offer is carefully curated to
                ensure comfort, safety, and unforgettable memories — while
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-3">
          <FeatureCard
            ...
            text="We partner with eco-conscious tour operators worldwide."
          />
          <FeatureCard
            title="All-Season Travel"
            text="Experiences designed for every climate and season."
          />
          <FeatureCard
            title="Quality Assured"
            text="Every trip is vetted for safety and comfort."
          />
        </div>
      </div>
    </section>
...
function FeatureCard({ title, text }: { title: string; text: string }) {
  return (
    <Card className="rounded-xl border-border bg-card/80 backdrop-blur">
      <CardContent className="p-5">
        <h4 className="mb-2 text-sm font-medium text-primary">{title}</h4>
  ...
  return (
    <section className="relative bg-background py-24">
      <div className="mx-auto max-w-7xl px-6">
        <h3 className="mb-14 text-3xl font-medium text-muted-foreground">
          Why Travelers Trust Wanderly
        </h3>
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
          ...
          <div>
            <p className="text-base leading-relaxed text-muted-foreground">
              We design journeys with intention — blending local expertise,
              premium comfort, and ethical partnerships. Every experience is
              reviewed to ensure it meets our standards of safety, authenticity,
              and lasting impact.
            </p>
          </div>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 gap-6 sm:grid-cols-2">
            <TrustCard
              ...
              text="Experienced guides who understand culture and terrain."
            />
            <TrustCard
              title="Carefully Vetted"
              text="Destinations and partners reviewed for quality."
            />
            <TrustCard
              title="Responsible Tourism"
              text="Supporting communities and protecting ecosystems."
            />
            <TrustCard
              title="Traveler Support"
              text="Assistance before, during, and after your trip."
            />
          </div>
        </div>
      </div>
...
function TrustCard({ title, text }: { title: string; text: string }) {
  return (
    <Card className="rounded-xl border-border bg-card/85 backdrop-blur">
      <CardContent className="p-6">
        <h4 className="mb-2 text-base font-medium text-foreground">{title}</h4>
    ...
    <section className="relative bg-background py-28">
      <div className="mx-auto max-w-7xl px-6">
        <div className="relative overflow-hidden rounded-2xl border border-border bg-card/90 backdrop-blur">
          ...
          <div className="relative grid grid-cols-1 items-center gap-12 p-14 md:grid-cols-2">
            {/* Text block */}
            <div>
              ...
              <p className="max-w-md text-base leading-relaxed text-muted-foreground">
                Whether you're planning your first adventure or your fiftieth,
                Wanderly gives you trusted destinations, expert guidance, and
